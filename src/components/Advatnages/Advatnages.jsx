...
import group from "../../assets/group-35935.png"

const Advatnages = () => {
  return (
    <div className="absolute top-[calc(50%_-_1373.3px)] left-[calc(50%_-_565px)] w-[1239.5px] h-[719.5px] text-29xl">
